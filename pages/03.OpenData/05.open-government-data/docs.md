...
--|---|---|
| Standardmäßig offene Daten | Open by default  | Open by default  |
| Qualität und Quantität /<br/> Zeitnah und umfassend | Quality and Quantity  | Timely and comprehensive  |
| Von allen verwendbar /<br/>(offen) zugänglich und verwendbar | Usable by All  | Accessible and Usable |
| Vergleichbar und Interoperabel |  | Comparable and Interoperable  |
| Freigabe von Daten für verbessertes staatliches Handeln und Einbeziehung von Bürgern | Releasing Data for Improved Governance  |  For Improved Governance And Citizen Engagement |
| Freigabe von Daten für Entwicklung und Innovation |  Releasing Data for Innovation  | For inclusive Development and Innovation  |

<!-- |<td colspan="3"markdown="1" >**Erläuterung:** Three</td>-->
