...
<h3><i class="fas fa-exchange-alt fa-2x" style="margin:10px"></i>Comparable and interoperable</h3> **Explanation**: The International Open Data Charter highlights the comparability and interoperability of data as an independent principle. Because more data is generally accessible, there are more and more ways to combine it and generate added value. An important prerequisite for this are generally valid data standards and data models.</div> |
1. Usable by all  | 3. Accessible and usable | <div class="rowspan" markdown="1">4. Ease of physical and electronic access<br/>5.  Machine readability<br/>6. Non-discrimination <br/> 7. Commonly owned or Open Standards<br/> 8. Licensing<br/>[...] <br/>10. Usage Costs</div>
...
[^1]: 1.	adopted by Canada, France, Germany, Italy, Japan, Russia, the United Kingdom (UK) and the United States (USA) on 18 June 2013
