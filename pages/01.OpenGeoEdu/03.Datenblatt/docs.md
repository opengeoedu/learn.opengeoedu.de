...
| Fallbeispiele  | | | |
|  :-----        | :----- | :----- | :----- |
| Elektromobilität | [Kommunale Erreichbarkeit von Ladestationen](OGE_Datenblatt_EMobi_Lokal_ABC.pdf) [color=green] [fa=fa-map-marked-alt extras=fa-2x][/color] | [OGE_Datenblatt_EMobi_National_ABC.pdf](OGE_Datenblatt_EMobi_National_ABC.pdf)[color=orange] [fa=map extras=fa-2x][/color] [color=green] [fa=map extras=fa-2x][/color] [color=blue] [fa=map extras=fa-2x][/color] | [OGE_Datenblatt_EMobi_Global_ABC.pdf](OGE_Datenblatt_EMobi_Global_ABC.pdf) |
