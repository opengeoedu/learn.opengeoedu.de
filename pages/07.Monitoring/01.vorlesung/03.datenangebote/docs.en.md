...
### Local/Regional:
The federal states and cities are often active in the Open Data movement, in Germany for example: Hamburg, Berlin, Nordrhine-Westphalia, Thuringia, Rhineland-Palatinate, Bavaria; as well as individul cities like Aachen, Bonn, Köln, Moers und Rostock (an extensive collection can be found in [OpenGeoEdu-Datenportal](https://portal.opengeoedu.de/)).
